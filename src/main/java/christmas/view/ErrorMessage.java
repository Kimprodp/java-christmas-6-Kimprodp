...
public class ErrorMessage {
    ...
    /*
    public static final String NOT_HYPHEN = "[ERROR] 메뉴와 수량은 하이픈('-')으로 구분하여 다시 입력해 주세요.";
    public static final String NOT_MenuQuantity_Integer = "[ERROR] 메뉴 수량은 숫자만 입력 가능합니다. 다시 입력해 주세요.";
     */
